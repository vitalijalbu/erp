...
export const initSetFeatureDefaultBlock = () => {

	Blockly.Blocks['set_feature_default'] = {
		...
		init: function () {
			this.appendDummyInput('SET')
				.appendField('Set Feature Default Value:')
			...
			this.setColour(95);
			this.setTooltip(`Set the default value of a feature. 
				Choosing "current" will set the value of the feature currently being processed.
