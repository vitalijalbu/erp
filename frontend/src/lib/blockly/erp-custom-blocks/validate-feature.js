...
export const initValidateFeatureBlock = () => {
	Blockly.Blocks["validate_feature"] = {
		itemCounter: 1,
		minInputs: 0,
		options: [],
		init: function () {
			this.appendDummyInput("ENABLE")
				.appendField("Validate Feature:")
				.appendField("Feature:")
				.appendField(
			...
			this.setColour(230);
			this.setTooltip(`Validate the value of a feature. 
				Choosing "current" will validate the feature currently being processed.
