...
import { MachineAutocomplete } from "./custom-fields/machine-autocomplete";


export const initMachineTimeBlock = () => {
	Blockly.Blocks["machine_workload"] = {
		itemCounter: 1,
		...
		init: function () {
			this.appendValueInput("VALUE")
				.appendField("Machine")
				.appendField( new MachineAutocomplete('', []), 'MACHINE')
