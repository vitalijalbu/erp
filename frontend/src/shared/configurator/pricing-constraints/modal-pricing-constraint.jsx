...
import PricingConstraint from "@/shared/configurator/pricing-constraints/form-body";

const ModalPricingConstraint = ({ opened, toggle, data, onSave }) => {
		...
		<>
			<Modal
				...
				title={
					data ? (
						<>
							Update Pricing Constraint <mark>{data.id}</mark>
						</>
					) : (
...
export default ModalPricingConstraint;
