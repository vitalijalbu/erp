...
//import ToolbarRouting from "@/shared/configurator/constraints/toolbar-pricing";
    ...
    },
    {
      ...
      render: (record) => (
        <>
          <div>
            <Space.Compact>
              <Link key={1} href={`/configurator/pricing-constraints/${record.id}`}>
    ...
    <>
      ...
      <PageActions
          title={
            subtype ? (
              <>
                Pricing Constraints - <mark>{subtype.toUpperCase()}</mark>
              </>
            ) : (
              "All Pricing Constraints"
            )
          }
          extra={[
            <Link href="/configurator/pricing-constraints/create" key={0}>
