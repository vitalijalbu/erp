...
import Toolbar from "@/shared/configurator/constraints/toolbar";
    ...
    },
    {
      ...
      render: (record) => (
        <>
          <div>
            <Space.Compact>
              <Link key={1} href={`/configurator/constraints/${record.id}`}>
      ...
      <div className="page">
        <PageActions
          title={
            subtype ? (
              <>
                All Constraints - <mark>{subtype.toUpperCase()}</mark>
              </>
            ) : (
              "All Constraints"
            )
          ...
          extra={[
            <Link href="/configurator/constraints/create" key="1">
