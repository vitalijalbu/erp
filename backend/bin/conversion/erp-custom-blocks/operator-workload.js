...
import { OperatorAutocomplete } from "./custom-fields/operator-autocomplete";


export const initOperatorTimeBlock = () => {
	Blockly.Blocks["operator_workload"] = {
		itemCounter: 1,
		...
		init: function () {
			this.appendValueInput("VALUE")
				...
				.appendField( new OperatorAutocomplete('', []), 'OPERATOR')
				.appendField('workload minutes:')
			...
			this.setOutput(true);
			this.setColour(10);
			this.setTooltip(`Get the value of a feature. 
				Choosing "current" will return the value of the feature currently being processed.
		...
		// 		var input = this.appendDummyInput("ADD" + this.itemCount_).appendField(
