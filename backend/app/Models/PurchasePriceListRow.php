...
class PurchasePriceListRow extends Model
{
    use HasFactory, HasCustomId, CheckOverlappingDates;

    protected $table = 'purchase_price_lists_rows';
    ...
    /**
     * Get the company that owns the PurchasePriceListRow
     *
    ...
    /**
     * Get the item that owns the PurchasePriceListRow
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    ...
    /**
     * Get the itemGroup that owns the PurchasePriceListRow
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    ...
    /**
     * Get the itemSubfamily that owns the PurchasePriceListRow
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    ...
    /**
     * Get the PurchasePriceList that owns the PurchasePriceListRow
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    public function purchasePriceList(): BelongsTo
    {
        return $this->belongsTo(PurchasePriceList::class, 'purchase_price_list_id', 'id');
    }
    ...
    protected static function booted(): void
    {
        ...
        static::saved(function (PurchasePriceListRow $row) {
            $row = $row->refresh();
        });
    }
    ...
    {
        return 
            PurchasePriceListRow::where([
                'company_id' => $companyId,
                'is_disabled' => false,
                'purchase_price_list_id' => $data['purchase_price_list_id']
            ])
            ->when(
                isset($data['quantity']), 
                function($q) use ($data){
