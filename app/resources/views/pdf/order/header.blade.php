<table style="table-layout:fixed; width:100%;  padding:0 50px;">
    <tr>
        ...
        <p style="font-size:12px;"><strong>Shop Order Number:</strong><br> {{$sale->code}}</p>
        <p style="font-size:12px;"><strong>Shop Order Date:</strong><br> {{$sale->created_at->format('M j, Y')}}</p>
        </td>
    </tr>
</table>