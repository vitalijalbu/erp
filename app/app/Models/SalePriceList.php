...
class SalePriceList extends Model implements PriceListInterface
{
    ...
    protected static function booted(): void
    {
        ...
        static::saved(function (SalePriceList $row) {
            $row = $row->refresh();
        });
    }

    /**
     * Get the company that owns the SalePriceList
     *
    ...
    /**
     * Get the currency that owns the SalePriceList
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    ...
    /**
     * Get the bp that owns the SalePriceList
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    ...
    {
        return $this->hasMany(SalePriceListRow::class, 'sales_price_list_id', 'id');
    }
    ...
    public function clone($data)
    {
        ...
        $this->rows->chunk(100)->each(function($rows) use ($data, $clone) {
            ...
            foreach($rows as $row){
                ...
                $clonedRow->sales_price_list_id = $clone->id;
