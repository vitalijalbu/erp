...
class ProcessPolicy
{
    ...
    {
        return $user->can('configurator.manage') || $user->can('routing.manage');
    }
    ...
    {
        return ($user->can('configurator.manage') || $user->can('routing.manage')) && $process->company_id == $user->IDcompany;
    }
