...
return new class extends Migration
{
    ...
    {
        Schema::create('sale_row_price_components', function (Blueprint $table) {
            ...
            $table->string('sale_total_discount_matrix_id', 100)->nullable();
            $table->string('sale_total_discount_matrix_row_id', 100)->nullable();
            $table->decimal('total_discount', 16, 4)->nullable();
            $table->decimal('total', 16, 4);
            $table->decimal('profit', 16, 4);
            $table->decimal('profit_perc', 16, 4);
            $table->bigInteger('standard_product_sale_pricing_group_id')->nullable();
        ...
        $this->createTrigger('sale_row_price_components', 'id', 'company_id');
    }
    ...
    {
        Schema::dropIfExists('sale_row_price_components');
    }
};
