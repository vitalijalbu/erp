...
export const initApplyDataSetBlock = () => {
	Blockly.Blocks["apply_dataset"] = {
		itemCounter: 1,
		minInputs: 0,
		options: [],

		init: function () {
			this.appendDummyInput("APPLY")
				.appendField("Apply Dataset    ")
				.appendField("Feature:")
				.appendField(
			...
			this.appendValueInput("DATA")
				.setCheck(["fetch_from_db", "dataset"])
				.appendField("Dataset:");
			...
			this.setColour(270);
			this.setTooltip(`Set the dataset associated to a feature. 
				Choosing "current" will create a dataset for the feature currently being processed.
