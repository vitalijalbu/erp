...
export default async function functionConverter (customFunction, out) {
    var workspace = new Blockly.Workspace();
    Blockly.serialization.workspaces.load(customFunction.body, workspace);
    const generated = generator.workspaceToCode(workspace);

    const phpCode = `<?php
        function ${customFunction.uuid}(${argsParser(customFunction.arguments || [])}) {
            ${generated}
        }
    `
